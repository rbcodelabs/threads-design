...
export interface SlashCommandContribution { readonly name: string; readonly thread?: { description: string; invoke(context: SlashCommandContext, host: SlashCommandHost): Promise<SlashCommandResult> }; readonly dispatch?: { description: string; invoke(context: SlashCommandContext, host: SlashCommandHost): Promise<SlashCommandResult> } }
